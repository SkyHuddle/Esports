...
export function StatBreakdown({ ratings, compact }: StatBreakdownProps) {
  const chips = [
    ...
    { label: 'UTL', value: String(ratings.utility) },
    { label: 'CLT', value: String(ratings.clutch) },
    { label: 'LAN', value: String(ratings.lan) },
    { label: 'INT', value: String(ratings.international) },
    { label: 'FK', value: String(ratings.firstKillPressure) },
    { label: 'IGL', value: String(ratings.leadership) },
    { label: 'FLX', value: String(ratings.roleFlexibility) },
  ];
