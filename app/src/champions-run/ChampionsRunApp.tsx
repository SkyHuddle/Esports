...
import { useChampionsRunGame } from './hooks/useChampionsRunGame';
...
export function ChampionsRunApp() {
  const game = useChampionsRunGame();
  ...
  return (
    <div className="kb-root min-h-[100dvh] antialiased relative overflow-x-hidden">
      <div className="fixed inset-0 mesh-bg-valorant pointer-events-none z-0" />
