...
export function SimulationScreen({ result, simSeed, onComplete }: SimulationScreenProps) {
  ...
  }, [stageIndex, result.stages, result.mvp.gamertag, simSeed]);
    ...
    <div className="flex flex-col min-h-[100dvh] items-center justify-center px-5 max-w-lg mx-auto py-10">
      ...
      <AnimatePresence>
        {showFinal && (
          ...
          >
            <MajorSummaryCard result={result} variant="sim" />
            <p className="text-center text-kb-mute text-xs mt-4 leading-relaxed px-2">
              {result.majorSummary.narrative}
            </p>
          </motion.div>
        )}
      </AnimatePresence>
