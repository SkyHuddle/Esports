...
interface DraftScreenProps {
  ...
  onSpinComplete: () => void;
  onRespinTeam: () => void;
  onSelectPlayer: (player: CsPlayer, naturalRole: RosterSlot) => void;
  onBack: () => void;
}
...
export function DraftScreen({
  ...
  const handleSelect = (player: CsPlayer, teamRole: RosterSlot) => {
    hapticTap();
      ...
      <header className="sticky top-11 z-20 px-5 pt-3 pb-3 kb-brand-bar">
        <div className="flex items-center justify-between gap-2 mb-3">
          ...
          <div className="flex flex-col items-center gap-1">
            <p className="text-[8px] uppercase tracking-[0.3em] font-semibold leading-none" style={{ color: 'var(--kb-steel)', opacity: 0.7 }}>
              Counter-Strike 2
            </p>
