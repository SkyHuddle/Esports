...
import { useMajorRunGame } from './hooks/useMajorRunGame';
...
export function MajorRunApp() {
  const game = useMajorRunGame();
  ...
  return (
    <div className="kb-root min-h-[100dvh] antialiased relative overflow-x-hidden">
      <div className="fixed inset-0 mesh-bg-cs pointer-events-none z-0" />
