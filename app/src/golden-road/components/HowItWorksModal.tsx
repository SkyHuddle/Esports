...
const STEPS = [
  { n: '1', text: 'Spin five team-years across Spring, MSI, Summer, and Worlds' },
  { n: '2', text: 'Draft one player per round for open roles' },
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 className="font-display text-2xl text-kb-fg mb-4">Five picks, one road</h2>
