    ...
    >
      ...
      >
        <div className="flex items-center gap-3.5">
          <div
            className="w-[52px] h-[52px] rounded-xl flex items-center justify-center text-base font-bold shrink-0 overflow-hidden"
            style={{
          ...
          >
            <span className="font-display leading-none tracking-wide select-none">
              {initials}
            </span>
          </div>
