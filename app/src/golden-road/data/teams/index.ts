import type { EsportId, HistoricalTeam, Player, Role } from '@/golden-road/core/types';
import { ROLES } from '@/golden-road/core/types';
import { LOL_TEAMS_RAW } from './lol';
import { LOL_WEAK_TEAMS } from './lol-weak';
import { withTeamMeta } from './meta';
import { getPlayerById } from '@/golden-road/data';
